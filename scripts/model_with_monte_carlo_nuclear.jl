...
dirpath = "/Users/pauorive23/Desktop/Màster BSE/Thesis/"
...
variables_to_draw = [
    ...
    "nonrenewable_waste_cap_mw", "conventional_hydro_cap_mw", "run_of_river_hydro_cap_mw", "pumped_hydro_cap_mw", 
...
for i in 1:num_iterations
    ...
    for var in variables_to_draw
        ...
        # If nuclear does not phase down, we expect lower deployment of batteries, since there will be more dispatchable capacity
        if var == "batteries_cap_mw" 
            new_data[!, var] .*= (1 + 0.75 * delta_draws[var])
...
combined_results_path = string(dirpath, "Results/Nuclear/combined_results.csv")
...
hourly_results_path = string(dirpath, "Results/Nuclear/hourly_results.csv")
...
monthly_results_path = string(dirpath, "Results/Nuclear/monthly_results.csv")
